	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Editar turma</h1>
				</div>
			...
			<form method="POST" action="{{ route('update-turma', $turma->slug)}}">
				@csrf
                @method('put')
                <div class="row g-2"> 
                <div class="col-md-4">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" required name="nome" value="{{$turma->nome}}" id="nome" placeholder="name@example.com">
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3">
                        <select required name="classe" class="form-select" id="floatingSelect" aria-label="Floating label select example">
							<option value="{{$turma->classe}}">{{$turma->classe}}</option>

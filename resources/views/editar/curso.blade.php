	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Editar curso</h1>
				</div>
			...
			<form method="POST" action="{{ route('update-curso', $curso->slug)}}">
				@csrf
                @method('put')
                <div class="row g-2"> 
                <div class="col-md-4">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="nome" value="{{ $curso->nome}}" id="nome" placeholder="name@example.com">

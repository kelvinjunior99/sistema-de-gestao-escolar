	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			<div class="row g-3 mb-4 align-items-center justify-content-between">
				<div class="col-auto">
					<h1 class="app-page-title mb-0">Cadastrar pagamento de uniforme</h1>
				</div>
			...
			<form method="POST" action="{{ route('create-uniforme')}}">
				@csrf
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" class="form-control" required name="quantidade"  id="nome" placeholder="name@example.com" min="1">
